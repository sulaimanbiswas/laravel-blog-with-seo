    ...
    <div class="max-w-full pb-10 pt-5">
        <div class="container max-w-[1140px] mx-auto px-3 md:px-3 lg:px-0 flex flex-col gap-5">
            ...
            <div class="flex justify-center items-center">
                @if(session('success'))
                <div class="p-4 mb-4 text-sm text-green-900 rounded-lg bg-green-100  max-w-md" role="alert">
                    {{ session('success') }}
                </div>
                @endif
            </div>
            ...
            <div class="grid grid-rows-1 md:grid-cols-12 gap-5 md:gap-10">
                <div class="col-span-12 md:col-span-6">
                    ...
                    <ol class="list-decimal ms-5 flex flex-col gap-2">
                        ...
                        <li>
                            <a class="hover:text-[#03a87c]" target="_blank" href="https://woolov.com">https://woolov.com</a>
                        </li>
                        <li>
                            <a class="hover:text-[#03a87c]" target="_blank" href="https://cordacio.info">https://cordacio.info</a>
                        </li>
                        <li>
                            <a class="hover:text-[#03a87c]" target="_blank" href="https://reactrone.info">https://reactrone.info</a>
                        </li>
                        <li>
                            <a class="hover:text-[#03a87c]" target="_blank" href="https://herven.org">https://herven.org</a>
                        </li>
                    </ol>
                </div>
                <div class="col-span-12 md:col-span-6">
                    ...
                    <form action="{{ route('contact.store') }}" method="post">
                        ...
                        <div class="flex justify-between items-center gap-4 mt-5">
                            <input required type="text" class="w-full font-cabin focus-within:ring-0 focus-within:border-[#03a87c] border-gray-300" name="name" placeholder="Your Name">
                            <input required type="email" class="w-full font-cabin focus-within:ring-0 focus-within:border-[#03a87c] border-gray-300" name="email" placeholder="Your Email">
                        </div>
                        <div class="flex justify-between items-center gap-4 mt-5">
                            <input required type="text" class="w-full font-cabin focus-within:ring-0 focus-within:border-[#03a87c] border-gray-300" name="subject" placeholder="Your Subject">
                        </div>
                        <div class="flex justify-between items-center gap-4 mt-5">
                            <textarea required type="text" class="w-full font-cabin focus-within:ring-0 focus-within:border-[#03a87c] border-gray-300" name="message" placeholder="Your Message" rows="10"></textarea>
                        </div>
                        <div class="flex justify-between items-center gap-4 mt-5">
