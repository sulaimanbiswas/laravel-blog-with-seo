    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <p
                ...
                class="bg-green-500 text-white py-4 px-8 block rounded-lg shadow">Your blog has created.</p>
            @endif
            ...
            <p
                ...
                x-transition
                x-init="setTimeout(() => show = false, 3000)"
                class="bg-green-500 text-white py-4 px-8 block rounded-lg shadow">Your blog has updated.</p>
            @endif
            ...
            <p
                ...
                x-transition
                x-init="setTimeout(() => show = false, 3000)"
                class="bg-green-500 text-white py-4 px-8 block rounded-lg shadow">Your blog has Deleted.</p>
            @endif
            ...
            <p
                ...
                x-transition
                x-init="setTimeout(() => show = false, 3000)"
                class="bg-red-500 text-white py-4 px-8 block rounded-lg shadow">Your blog doesn`t deleted.</p>
            @endif
