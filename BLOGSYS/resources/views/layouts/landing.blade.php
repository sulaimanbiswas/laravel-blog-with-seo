...
<body class="">
        ...
        <button
                id="backToTopBtn"
                type="button"
                class="fixed bottom-5 right-5 bg-transparent gap text-primary font-bold rotate-90  px-4 py-2 rounded-full tracking-widest text-xs uppercase transition-opacity duration-300 opacity-0 hidden">
                        ...
                        <ul class="flex items-center gap-1">
                                <li class="border w-[26px] h-[26px] rounded-full border-primary">
                                        <a href="#" class=" flex justify-center items-center text-primary hover:text-[#03a87c] text-[14px] w-full h-full">
                                                <svg width="14" height="14" class="-mt-[3px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M17.7512 2.96094H20.818L14.1179 10.6187L22 21.0391H15.8284L10.9946 14.7191L5.4636 21.0391H2.39492L9.56132 12.8483L2 2.96094H8.32824L12.6976 8.73762L17.7512 2.96094ZM16.6748 19.2035H18.3742L7.40492 4.70014H5.58132L16.6748 19.2035Z" fill="#0000008a" />
                                                </svg>
                                ...
                                <li class="border w-[26px] h-[26px] rounded-full border-primary">
                                        <a href="#" class=" flex justify-center items-center text-primary hover:text-[#03a87c] text-[14px] w-full h-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 320 512">
                                                        <path d="M80 299.3V512H196V299.3h86.5l18-97.8H196V166.9c0-51.7 20.3-71.5 72.7-71.5c16.3 0 29.4 .4 37 1.2V7.9C291.4 4 256.4 0 236.2 0C129.3 0 80 50.5 80 159.4v42.1H14v97.8H80z" fill="#0000008a" />
                                                </svg>
